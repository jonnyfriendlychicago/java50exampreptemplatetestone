...
<body>
	...
	<div id=main class="container-fluid">
		<div id=form class="container-fluid">
			<h3>Add a Teacher</h3>
			<%-- <form:form action='/store/teacher/new' method='post' modelAttribute='teacher'> --%>
			<form:form action='/teacher/new' method='post' modelAttribute='teacher'>
				...
				<div class="form-group">
					<form:label path="teacherName" for="teacherName">teacherName</form:label>
					<form:input type="text" class="form-control" path="teacherName"/>
					<p class="errorText"><form:errors path="teacherName" />
					</p>
				</div>
